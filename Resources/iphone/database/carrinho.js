...
function insertCarrinho(car_session_id, car_quantidade, car_preco_unitario, car_ipi, car_icms, car_entrega, car_entrega_prazo, car_status, car_data, car_replica, fk_usu, fk_produtos, fk_tamanhos, fk_cores, fk_cli, ep_id, car_desc_unit, car_entrega, car_entrega_prazo) {
    db = dbLoad();
    db.execute("INSERT INTO " + getTableCarrinho() + " (\n		car_session_id, car_quantidade, car_preco_unitario, car_ipi, car_icms, car_entrega, car_entrega_prazo, \n	car_status, car_data, car_replica, fk_usu, fk_produtos, fk_tamanhos, fk_cores, fk_cli, ep_id, car_desc_unit, car_entrega, car_entrega_prazo) \n	VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", car_session_id, car_quantidade, car_preco_unitario, car_ipi, car_icms, car_entrega, car_entrega_prazo, car_status, car_data, car_replica, fk_usu, fk_produtos, fk_tamanhos, fk_cores, fk_cli, ep_id, car_desc_unit, car_entrega, car_entrega_prazo);
    db.close();
}
