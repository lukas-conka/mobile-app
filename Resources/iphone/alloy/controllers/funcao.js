...
function Controller() {
    ...
    function goToOnline() {
        ...
        } else Ti.Platform.openURL("http://marcas.e-catalogos.net");
    }
    ...
    function goToEmail() {
        ...
        emailDialog.addEventListener("complete", function(e) {
            e.result == emailDialog.SENT ? "android" != Ti.Platform.osname && alert("message enviado") : alert("message não foi enviado!");
        });
    }
