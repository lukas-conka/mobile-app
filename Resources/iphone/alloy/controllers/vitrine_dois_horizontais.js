...
function Controller() {
    ...
    $.__views.vitrine_dois_horizontais.add($.__views.__alloyId1459);
    ...
    $.__views.__alloyId1459.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1460);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1460.add($.__views.imagemA);
    $.__views.__alloyId1461 = Ti.UI.createView({
        layout: "horizontal",
        width: "98%",
        id: "__alloyId1461"
    });
    $.__views.gradeA.add($.__views.__alloyId1461);
    ...
    $.__views.__alloyId1461.add($.__views.precoA);
    ...
    $.__views.__alloyId1461.add($.__views.tempoA);
    ...
    $.__views.__alloyId1461.add($.__views.selecionaA);
    ...
    $.__views.__alloyId1461.add($.__views.imagesA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1462);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1462.add($.__views.imagemB);
    $.__views.__alloyId1463 = Ti.UI.createView({
        layout: "horizontal",
        width: "98%",
        id: "__alloyId1463"
    });
    $.__views.gradeB.add($.__views.__alloyId1463);
    ...
    $.__views.__alloyId1463.add($.__views.precoB);
    ...
    $.__views.__alloyId1463.add($.__views.tempoB);
    ...
    $.__views.__alloyId1463.add($.__views.selecionaB);
    ...
    $.__views.__alloyId1463.add($.__views.imagesB);
    ...
    $.__views.vitrine_dois_horizontais.add($.__views.__alloyId1464);
    ...
    $.__views.__alloyId1465.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1466 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1466.addEventListener("click", voltar) : __defers["$.__views.__alloyId1466!click!voltar"] = true;
    ...
    $.__views.__alloyId1468 = Ti.UI.createImageView({
    ...
    primeiro ? $.__views.__alloyId1468.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1468!click!primeiro"] = true;
    $.__views.__alloyId1469 = Ti.UI.createImageView({
    ...
    anterior ? $.__views.__alloyId1469.addEventListener("click", anterior) : __defers["$.__views.__alloyId1469!click!anterior"] = true;
    ...
    $.__views.__alloyId1467.add($.__views.paginacao);
    ...
    proximo ? $.__views.__alloyId1470.addEventListener("click", proximo) : __defers["$.__views.__alloyId1470!click!proximo"] = true;
    ...
    $.__views.__alloyId1467.add($.__views.__alloyId1471);
    ultimo ? $.__views.__alloyId1471.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1471!click!ultimo"] = true;
    ...
    $.__views.__alloyId1464.add($.__views.__alloyId1472);
    $.__views.__alloyId1473 = Ti.UI.createImageView({
    ...
    cesta ? $.__views.__alloyId1473.addEventListener("click", cesta) : __defers["$.__views.__alloyId1473!click!cesta"] = true;
    ...
    $.__views.__alloyId1472.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1466!click!voltar"] && $.__views.__alloyId1466.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1468!click!primeiro"] && $.__views.__alloyId1468.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1469!click!anterior"] && $.__views.__alloyId1469.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1470!click!proximo"] && $.__views.__alloyId1470.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1471!click!ultimo"] && $.__views.__alloyId1471.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1473!click!cesta"] && $.__views.__alloyId1473.addEventListener("click", cesta);
    _.extend($, exports);
}
