...
function Controller() {
    ...
    $.__views.vitrine_quatro_verticais.add($.__views.__alloyId1525);
    ...
    $.__views.__alloyId1525.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1526);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1526.add($.__views.imagemA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1527);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1527.add($.__views.imagemB);
    ...
    $.__views.gradeC.add($.__views.__alloyId1528);
    $.__views.imagemC = Ti.UI.createImageView({
        width: "100%",
        id: "imagemC"
    });
    $.__views.__alloyId1528.add($.__views.imagemC);
    ...
    $.__views.gradeD.add($.__views.__alloyId1529);
    $.__views.imagemD = Ti.UI.createImageView({
        width: "100%",
        id: "imagemD"
    });
    $.__views.__alloyId1529.add($.__views.imagemD);
    ...
    $.__views.vitrine_quatro_verticais.add($.__views.__alloyId1530);
