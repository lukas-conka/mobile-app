...
function Controller() {
    ...
    $.__views.vitrine_cinco_verticais.add($.__views.__alloyId1524);
    ...
    $.__views.__alloyId1524.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1525);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1525.add($.__views.imagemA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1526);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1526.add($.__views.imagemB);
    ...
    $.__views.gradeC.add($.__views.__alloyId1527);
    $.__views.imagemC = Ti.UI.createImageView({
        width: "100%",
        id: "imagemC"
    });
    $.__views.__alloyId1527.add($.__views.imagemC);
    ...
    $.__views.gradeD.add($.__views.__alloyId1528);
    $.__views.imagemD = Ti.UI.createImageView({
        width: "100%",
        id: "imagemD"
    });
    $.__views.__alloyId1528.add($.__views.imagemD);
    ...
    $.__views.gradeE.add($.__views.__alloyId1529);
    $.__views.imagemE = Ti.UI.createImageView({
        width: "100%",
        id: "imagemE"
    });
    $.__views.__alloyId1529.add($.__views.imagemE);
    ...
    $.__views.vitrine_cinco_verticais.add($.__views.__alloyId1530);
    ...
    $.__views.__alloyId1531.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1532 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1532.addEventListener("click", voltar) : __defers["$.__views.__alloyId1532!click!voltar"] = true;
    ...
    primeiro ? $.__views.__alloyId1534.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1534!click!primeiro"] = true;
    $.__views.__alloyId1535 = Ti.UI.createImageView({
    ...
    anterior ? $.__views.__alloyId1535.addEventListener("click", anterior) : __defers["$.__views.__alloyId1535!click!anterior"] = true;
    ...
    $.__views.__alloyId1533.add($.__views.paginacao);
    ...
    $.__views.__alloyId1533.add($.__views.__alloyId1536);
    proximo ? $.__views.__alloyId1536.addEventListener("click", proximo) : __defers["$.__views.__alloyId1536!click!proximo"] = true;
    ...
    $.__views.__alloyId1533.add($.__views.__alloyId1537);
    ultimo ? $.__views.__alloyId1537.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1537!click!ultimo"] = true;
    ...
    $.__views.__alloyId1530.add($.__views.__alloyId1538);
    ...
    cesta ? $.__views.__alloyId1539.addEventListener("click", cesta) : __defers["$.__views.__alloyId1539!click!cesta"] = true;
    ...
    $.__views.__alloyId1538.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1532!click!voltar"] && $.__views.__alloyId1532.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1534!click!primeiro"] && $.__views.__alloyId1534.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1535!click!anterior"] && $.__views.__alloyId1535.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1536!click!proximo"] && $.__views.__alloyId1536.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1537!click!ultimo"] && $.__views.__alloyId1537.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1539!click!cesta"] && $.__views.__alloyId1539.addEventListener("click", cesta);
    _.extend($, exports);
}
