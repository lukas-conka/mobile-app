...
function Controller() {
    ...
    $.__views.suporte.add($.__views.__alloyId1449);
    $.__views.__alloyId1450 = Ti.UI.createButton({
        backgroundColor: "#ffffff",
        color: "#000000",
        right: "10",
        title: "SUPORTE",
    ...
    $.__views.__alloyId1449.add($.__views.logoEmpresa);
    ...
    $.__views.suporte.add($.__views.__alloyId1451);
    ...
    $.__views.__alloyId1453.add($.__views.__alloyId1456);
    ...
    $.__views.__alloyId1451.add($.__views.__alloyId1457);
    ...
    $.__views.__alloyId1459 = Ti.UI.createImageView({
        height: "100%",
    ...
    $.__views.__alloyId1451.add($.__views.__alloyId1461);
    ...
    $.__views.__alloyId1463 = Ti.UI.createImageView({
        height: "100%",
    ...
    $.__views.__alloyId1461.add($.__views.__alloyId1464);
    ...
    $.__views.__alloyId1451.add($.__views.__alloyId1465);
    ...
    $.__views.__alloyId1467 = Ti.UI.createImageView({
        height: "100%",
    ...
    $.__views.__alloyId1465.add($.__views.__alloyId1468);
    ...
    $.__views.__alloyId1451.add($.__views.__alloyId1469);
    ...
    $.__views.suporte.add($.__views.__alloyId1473);
    $.__views.__alloyId1474 = Ti.UI.createButton({
        backgroundGradient: {
            type: "linear",
    ...
    voltar ? $.__views.__alloyId1474.addEventListener("click", voltar) : __defers["$.__views.__alloyId1474!click!voltar"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    Ti.include("/api/config.js");
    Ti.include("/database/aparencia.js");
    $.logoEmpresa.image = getImagesFolder() + selectLogoFile();
    __defers["$.__views.__alloyId1474!click!voltar"] && $.__views.__alloyId1474.addEventListener("click", voltar);
    _.extend($, exports);
}
