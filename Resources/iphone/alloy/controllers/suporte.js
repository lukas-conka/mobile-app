...
function Controller() {
    ...
    $.__views.__alloyId1444.add($.__views.logoEmpresa);
    ...
    $.__views.suporte.add($.__views.__alloyId1446);
    ...
    $.__views.__alloyId1450 = Ti.UI.createImageView({
        height: "100%",
    ...
    $.__views.__alloyId1446.add($.__views.__alloyId1452);
    ...
    $.__views.__alloyId1456.add($.__views.__alloyId1459);
    ...
    $.__views.__alloyId1446.add($.__views.__alloyId1460);
    ...
    $.__views.__alloyId1446.add($.__views.__alloyId1464);
    ...
    $.__views.suporte.add($.__views.__alloyId1468);
    $.__views.__alloyId1469 = Ti.UI.createButton({
        backgroundGradient: {
            type: "linear",
    ...
    voltar ? $.__views.__alloyId1469.addEventListener("click", voltar) : __defers["$.__views.__alloyId1469!click!voltar"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    Ti.include("/api/config.js");
    Ti.include("/database/aparencia.js");
    $.logoEmpresa.image = getImagesFolder() + selectLogoFile();
    __defers["$.__views.__alloyId1469!click!voltar"] && $.__views.__alloyId1469.addEventListener("click", voltar);
    _.extend($, exports);
}
