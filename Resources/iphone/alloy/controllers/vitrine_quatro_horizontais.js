...
function Controller() {
    ...
    $.__views.__alloyId1561.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1562);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1562.add($.__views.imagemA);
    ...
    $.__views.gradeA.add($.__views.__alloyId1563);
    ...
    $.__views.__alloyId1563.add($.__views.precoA);
    ...
    $.__views.__alloyId1563.add($.__views.tempoA);
    ...
    $.__views.__alloyId1563.add($.__views.selecionaA);
    ...
    $.__views.__alloyId1563.add($.__views.imagesA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1564);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1564.add($.__views.imagemB);
    ...
    $.__views.gradeB.add($.__views.__alloyId1565);
    ...
    $.__views.__alloyId1565.add($.__views.precoB);
    ...
    $.__views.__alloyId1565.add($.__views.tempoB);
    ...
    $.__views.__alloyId1565.add($.__views.selecionaB);
    ...
    $.__views.__alloyId1565.add($.__views.imagesB);
    ...
    $.__views.gradeC.add($.__views.__alloyId1566);
    $.__views.imagemC = Ti.UI.createImageView({
        width: "100%",
        id: "imagemC"
    });
    $.__views.__alloyId1566.add($.__views.imagemC);
    ...
    $.__views.gradeC.add($.__views.__alloyId1567);
    ...
    $.__views.__alloyId1567.add($.__views.precoC);
    ...
    $.__views.__alloyId1567.add($.__views.tempoC);
    ...
    $.__views.__alloyId1567.add($.__views.selecionaC);
    ...
    $.__views.__alloyId1567.add($.__views.imagesC);
    ...
    $.__views.gradeD.add($.__views.__alloyId1568);
    $.__views.imagemD = Ti.UI.createImageView({
        width: "100%",
        id: "imagemD"
    });
    $.__views.__alloyId1568.add($.__views.imagemD);
    ...
    $.__views.gradeD.add($.__views.__alloyId1569);
    ...
    $.__views.__alloyId1569.add($.__views.precoD);
    ...
    $.__views.__alloyId1569.add($.__views.tempoD);
    ...
    $.__views.__alloyId1569.add($.__views.selecionaD);
    ...
    $.__views.__alloyId1569.add($.__views.imagesD);
    ...
    $.__views.__alloyId1561.add($.__views.__alloyId1570);
    ...
    $.__views.__alloyId1571.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1572 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1572.addEventListener("click", voltar) : __defers["$.__views.__alloyId1572!click!voltar"] = true;
    ...
    primeiro ? $.__views.__alloyId1574.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1574!click!primeiro"] = true;
    ...
    anterior ? $.__views.__alloyId1575.addEventListener("click", anterior) : __defers["$.__views.__alloyId1575!click!anterior"] = true;
    ...
    $.__views.__alloyId1573.add($.__views.paginacao);
    ...
    $.__views.__alloyId1573.add($.__views.__alloyId1576);
    proximo ? $.__views.__alloyId1576.addEventListener("click", proximo) : __defers["$.__views.__alloyId1576!click!proximo"] = true;
    ...
    $.__views.__alloyId1573.add($.__views.__alloyId1577);
    ultimo ? $.__views.__alloyId1577.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1577!click!ultimo"] = true;
    ...
    $.__views.__alloyId1570.add($.__views.__alloyId1578);
    ...
    cesta ? $.__views.__alloyId1579.addEventListener("click", cesta) : __defers["$.__views.__alloyId1579!click!cesta"] = true;
    ...
    $.__views.__alloyId1578.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1572!click!voltar"] && $.__views.__alloyId1572.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1574!click!primeiro"] && $.__views.__alloyId1574.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1575!click!anterior"] && $.__views.__alloyId1575.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1576!click!proximo"] && $.__views.__alloyId1576.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1577!click!ultimo"] && $.__views.__alloyId1577.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1579!click!cesta"] && $.__views.__alloyId1579.addEventListener("click", cesta);
    _.extend($, exports);
}
