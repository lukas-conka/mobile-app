...
function Controller() {
    ...
    $.__views.totalizacoes.add($.__views.__alloyId1468);
    ...
    $.__views.totalizacoes.add($.__views.__alloyId1469);
    ...
    $.__views.__alloyId1470.add($.__views.total);
    ...
    voltar ? $.__views.__alloyId1473.addEventListener("click", voltar) : __defers["$.__views.__alloyId1473!click!voltar"] = true;
    ...
    __defers["$.__views.__alloyId1473!click!voltar"] && $.__views.__alloyId1473.addEventListener("click", voltar);
    _.extend($, exports);
}
