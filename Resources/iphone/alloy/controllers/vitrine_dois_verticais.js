...
function Controller() {
    ...
    $.__views.vitrine_dois_verticais.add($.__views.__alloyId1474);
    ...
    $.__views.__alloyId1474.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1475);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1475.add($.__views.imagemA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1476);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1476.add($.__views.imagemB);
    ...
    $.__views.vitrine_dois_verticais.add($.__views.__alloyId1477);
    ...
    $.__views.__alloyId1478.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1479 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1479.addEventListener("click", voltar) : __defers["$.__views.__alloyId1479!click!voltar"] = true;
    ...
    primeiro ? $.__views.__alloyId1481.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1481!click!primeiro"] = true;
    ...
    anterior ? $.__views.__alloyId1482.addEventListener("click", anterior) : __defers["$.__views.__alloyId1482!click!anterior"] = true;
    ...
    $.__views.__alloyId1480.add($.__views.paginacao);
    $.__views.__alloyId1483 = Ti.UI.createImageView({
    ...
    proximo ? $.__views.__alloyId1483.addEventListener("click", proximo) : __defers["$.__views.__alloyId1483!click!proximo"] = true;
    $.__views.__alloyId1484 = Ti.UI.createImageView({
    ...
    $.__views.__alloyId1480.add($.__views.__alloyId1484);
    ultimo ? $.__views.__alloyId1484.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1484!click!ultimo"] = true;
    ...
    $.__views.__alloyId1477.add($.__views.__alloyId1485);
    $.__views.__alloyId1486 = Ti.UI.createImageView({
    ...
    cesta ? $.__views.__alloyId1486.addEventListener("click", cesta) : __defers["$.__views.__alloyId1486!click!cesta"] = true;
    ...
    $.__views.__alloyId1485.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1479!click!voltar"] && $.__views.__alloyId1479.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1481!click!primeiro"] && $.__views.__alloyId1481.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1482!click!anterior"] && $.__views.__alloyId1482.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1483!click!proximo"] && $.__views.__alloyId1483.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1484!click!ultimo"] && $.__views.__alloyId1484.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1486!click!cesta"] && $.__views.__alloyId1486.addEventListener("click", cesta);
    _.extend($, exports);
}
