...
function Controller() {
    ...
    $.__views.vitrine_dois_verticais.add($.__views.__alloyId1548);
    ...
    $.__views.__alloyId1548.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1549);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1549.add($.__views.imagemA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1550);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1550.add($.__views.imagemB);
    ...
    $.__views.vitrine_dois_verticais.add($.__views.__alloyId1551);
    ...
    $.__views.__alloyId1552.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1553 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1553.addEventListener("click", voltar) : __defers["$.__views.__alloyId1553!click!voltar"] = true;
    ...
    primeiro ? $.__views.__alloyId1555.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1555!click!primeiro"] = true;
    ...
    anterior ? $.__views.__alloyId1556.addEventListener("click", anterior) : __defers["$.__views.__alloyId1556!click!anterior"] = true;
    ...
    $.__views.__alloyId1554.add($.__views.paginacao);
    ...
    proximo ? $.__views.__alloyId1557.addEventListener("click", proximo) : __defers["$.__views.__alloyId1557!click!proximo"] = true;
    ...
    $.__views.__alloyId1554.add($.__views.__alloyId1558);
    ultimo ? $.__views.__alloyId1558.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1558!click!ultimo"] = true;
    ...
    $.__views.__alloyId1551.add($.__views.__alloyId1559);
    ...
    cesta ? $.__views.__alloyId1560.addEventListener("click", cesta) : __defers["$.__views.__alloyId1560!click!cesta"] = true;
    ...
    $.__views.__alloyId1559.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1553!click!voltar"] && $.__views.__alloyId1553.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1555!click!primeiro"] && $.__views.__alloyId1555.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1556!click!anterior"] && $.__views.__alloyId1556.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1557!click!proximo"] && $.__views.__alloyId1557.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1558!click!ultimo"] && $.__views.__alloyId1558.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1560!click!cesta"] && $.__views.__alloyId1560.addEventListener("click", cesta);
    _.extend($, exports);
}
