...
function Controller() {
    ...
    $.__views.sincronizacao.add($.__views.__alloyId1408);
    ...
    $.__views.sincronizacao.add($.__views.__alloyId1409);
    ...
    exportar ? $.__views.__alloyId1413.addEventListener("click", exportar) : __defers["$.__views.__alloyId1413!click!exportar"] = true;
    ...
    $.__views.__alloyId1409.add($.__views.__alloyId1414);
    ...
    importar ? $.__views.__alloyId1417.addEventListener("click", importar) : __defers["$.__views.__alloyId1417!click!importar"] = true;
    ...
    $.__views.sincronizacao.add($.__views.__alloyId1418);
    $.__views.__alloyId1419 = Ti.UI.createButton({
        backgroundGradient: {
            type: "linear",
            colors: [ "#2c8f8e", "#206764" ]
        },
    ...
    voltar ? $.__views.__alloyId1419.addEventListener("click", voltar) : __defers["$.__views.__alloyId1419!click!voltar"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    arguments[0] || {};
    __defers["$.__views.__alloyId1413!click!exportar"] && $.__views.__alloyId1413.addEventListener("click", exportar);
    __defers["$.__views.__alloyId1417!click!importar"] && $.__views.__alloyId1417.addEventListener("click", importar);
    __defers["$.__views.__alloyId1419!click!voltar"] && $.__views.__alloyId1419.addEventListener("click", voltar);
    _.extend($, exports);
}
