...
function Controller() {
    ...
    $.__views.vitrine_dois_verticais.add($.__views.__alloyId1550);
    ...
    $.__views.__alloyId1550.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1551);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1551.add($.__views.imagemA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1552);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1552.add($.__views.imagemB);
    ...
    $.__views.vitrine_dois_verticais.add($.__views.__alloyId1553);
    ...
    $.__views.__alloyId1554.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1555 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1555.addEventListener("click", voltar) : __defers["$.__views.__alloyId1555!click!voltar"] = true;
    ...
    $.__views.__alloyId1553.add($.__views.__alloyId1556);
    ...
    primeiro ? $.__views.__alloyId1557.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1557!click!primeiro"] = true;
    $.__views.__alloyId1558 = Ti.UI.createImageView({
    ...
    anterior ? $.__views.__alloyId1558.addEventListener("click", anterior) : __defers["$.__views.__alloyId1558!click!anterior"] = true;
    ...
    $.__views.__alloyId1556.add($.__views.paginacao);
    ...
    proximo ? $.__views.__alloyId1559.addEventListener("click", proximo) : __defers["$.__views.__alloyId1559!click!proximo"] = true;
    ...
    ultimo ? $.__views.__alloyId1560.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1560!click!ultimo"] = true;
    ...
    $.__views.__alloyId1553.add($.__views.__alloyId1561);
    ...
    cesta ? $.__views.__alloyId1562.addEventListener("click", cesta) : __defers["$.__views.__alloyId1562!click!cesta"] = true;
    ...
    $.__views.__alloyId1561.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1555!click!voltar"] && $.__views.__alloyId1555.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1557!click!primeiro"] && $.__views.__alloyId1557.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1558!click!anterior"] && $.__views.__alloyId1558.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1559!click!proximo"] && $.__views.__alloyId1559.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1560!click!ultimo"] && $.__views.__alloyId1560.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1562!click!cesta"] && $.__views.__alloyId1562.addEventListener("click", cesta);
    _.extend($, exports);
}
