...
function Controller() {
    ...
    $.__views.__alloyId1446.add($.__views.logoEmpresa);
    ...
    $.__views.suporte.add($.__views.__alloyId1448);
    ...
    $.__views.__alloyId1448.add($.__views.__alloyId1458);
    ...
    $.__views.__alloyId1448.add($.__views.__alloyId1462);
    ...
    $.__views.__alloyId1448.add($.__views.__alloyId1466);
    ...
    $.__views.suporte.add($.__views.__alloyId1470);
    $.__views.__alloyId1471 = Ti.UI.createButton({
        backgroundGradient: {
            type: "linear",
    ...
    voltar ? $.__views.__alloyId1471.addEventListener("click", voltar) : __defers["$.__views.__alloyId1471!click!voltar"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    Ti.include("/api/config.js");
    Ti.include("/database/aparencia.js");
    $.logoEmpresa.image = getImagesFolder() + selectLogoFile();
    __defers["$.__views.__alloyId1471!click!voltar"] && $.__views.__alloyId1471.addEventListener("click", voltar);
    _.extend($, exports);
}
