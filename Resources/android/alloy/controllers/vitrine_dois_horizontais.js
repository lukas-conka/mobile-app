...
function Controller() {
    ...
    $.__views.vitrine_dois_horizontais.add($.__views.__alloyId1537);
    ...
    $.__views.__alloyId1537.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1538);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1538.add($.__views.imagemA);
    $.__views.__alloyId1539 = Ti.UI.createView({
        layout: "horizontal",
        width: "98%",
        id: "__alloyId1539"
    });
    $.__views.gradeA.add($.__views.__alloyId1539);
    ...
    $.__views.__alloyId1539.add($.__views.precoA);
    ...
    $.__views.__alloyId1539.add($.__views.tempoA);
    ...
    $.__views.__alloyId1539.add($.__views.selecionaA);
    ...
    $.__views.__alloyId1539.add($.__views.imagesA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1540);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1540.add($.__views.imagemB);
    $.__views.__alloyId1541 = Ti.UI.createView({
        layout: "horizontal",
        width: "98%",
        id: "__alloyId1541"
    });
    $.__views.gradeB.add($.__views.__alloyId1541);
    ...
    $.__views.__alloyId1541.add($.__views.precoB);
    ...
    $.__views.__alloyId1541.add($.__views.tempoB);
    ...
    $.__views.__alloyId1541.add($.__views.selecionaB);
    ...
    $.__views.__alloyId1541.add($.__views.imagesB);
    ...
    $.__views.vitrine_dois_horizontais.add($.__views.__alloyId1542);
    ...
    $.__views.__alloyId1543.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1544 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1544.addEventListener("click", voltar) : __defers["$.__views.__alloyId1544!click!voltar"] = true;
    ...
    primeiro ? $.__views.__alloyId1546.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1546!click!primeiro"] = true;
    ...
    $.__views.__alloyId1545.add($.__views.__alloyId1547);
    anterior ? $.__views.__alloyId1547.addEventListener("click", anterior) : __defers["$.__views.__alloyId1547!click!anterior"] = true;
    ...
    $.__views.__alloyId1545.add($.__views.paginacao);
    ...
    $.__views.__alloyId1545.add($.__views.__alloyId1548);
    proximo ? $.__views.__alloyId1548.addEventListener("click", proximo) : __defers["$.__views.__alloyId1548!click!proximo"] = true;
    ...
    $.__views.__alloyId1545.add($.__views.__alloyId1549);
    ultimo ? $.__views.__alloyId1549.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1549!click!ultimo"] = true;
    ...
    $.__views.__alloyId1542.add($.__views.__alloyId1550);
    ...
    cesta ? $.__views.__alloyId1551.addEventListener("click", cesta) : __defers["$.__views.__alloyId1551!click!cesta"] = true;
    ...
    $.__views.__alloyId1550.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1544!click!voltar"] && $.__views.__alloyId1544.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1546!click!primeiro"] && $.__views.__alloyId1546.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1547!click!anterior"] && $.__views.__alloyId1547.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1548!click!proximo"] && $.__views.__alloyId1548.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1549!click!ultimo"] && $.__views.__alloyId1549.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1551!click!cesta"] && $.__views.__alloyId1551.addEventListener("click", cesta);
    _.extend($, exports);
}
