...
function Controller() {
    ...
    $.__views.vitrine_dois_horizontais.add($.__views.__alloyId1535);
    ...
    $.__views.__alloyId1535.add($.__views.vitrine);
    ...
    $.__views.gradeA.add($.__views.__alloyId1536);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1536.add($.__views.imagemA);
    $.__views.__alloyId1537 = Ti.UI.createView({
        layout: "horizontal",
        width: "98%",
        id: "__alloyId1537"
    });
    $.__views.gradeA.add($.__views.__alloyId1537);
    ...
    $.__views.__alloyId1537.add($.__views.precoA);
    ...
    $.__views.__alloyId1537.add($.__views.tempoA);
    ...
    $.__views.__alloyId1537.add($.__views.selecionaA);
    ...
    $.__views.__alloyId1537.add($.__views.imagesA);
    ...
    $.__views.gradeB.add($.__views.__alloyId1538);
    $.__views.imagemB = Ti.UI.createImageView({
        width: "100%",
        id: "imagemB"
    });
    $.__views.__alloyId1538.add($.__views.imagemB);
    $.__views.__alloyId1539 = Ti.UI.createView({
        layout: "horizontal",
        width: "98%",
        id: "__alloyId1539"
    });
    $.__views.gradeB.add($.__views.__alloyId1539);
    ...
    $.__views.__alloyId1539.add($.__views.precoB);
    ...
    $.__views.__alloyId1539.add($.__views.tempoB);
    ...
    $.__views.__alloyId1539.add($.__views.selecionaB);
    ...
    $.__views.__alloyId1539.add($.__views.imagesB);
    ...
    $.__views.vitrine_dois_horizontais.add($.__views.__alloyId1540);
    ...
    $.__views.__alloyId1541.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1542 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1542.addEventListener("click", voltar) : __defers["$.__views.__alloyId1542!click!voltar"] = true;
    ...
    primeiro ? $.__views.__alloyId1544.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1544!click!primeiro"] = true;
    ...
    anterior ? $.__views.__alloyId1545.addEventListener("click", anterior) : __defers["$.__views.__alloyId1545!click!anterior"] = true;
    ...
    $.__views.__alloyId1543.add($.__views.paginacao);
    ...
    $.__views.__alloyId1543.add($.__views.__alloyId1546);
    proximo ? $.__views.__alloyId1546.addEventListener("click", proximo) : __defers["$.__views.__alloyId1546!click!proximo"] = true;
    ...
    $.__views.__alloyId1543.add($.__views.__alloyId1547);
    ultimo ? $.__views.__alloyId1547.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1547!click!ultimo"] = true;
    ...
    $.__views.__alloyId1540.add($.__views.__alloyId1548);
    ...
    cesta ? $.__views.__alloyId1549.addEventListener("click", cesta) : __defers["$.__views.__alloyId1549!click!cesta"] = true;
    ...
    $.__views.__alloyId1548.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1542!click!voltar"] && $.__views.__alloyId1542.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1544!click!primeiro"] && $.__views.__alloyId1544.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1545!click!anterior"] && $.__views.__alloyId1545.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1546!click!proximo"] && $.__views.__alloyId1546.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1547!click!ultimo"] && $.__views.__alloyId1547.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1549!click!cesta"] && $.__views.__alloyId1549.addEventListener("click", cesta);
    _.extend($, exports);
}
