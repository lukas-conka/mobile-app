...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId1645);
    ...
    $.__views.__alloyId1645.add($.__views.gradeA);
    ...
    $.__views.gradeA.add($.__views.__alloyId1646);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1646.add($.__views.imagemA);
    ...
    $.__views.gradeA.add($.__views.__alloyId1647);
    ...
    $.__views.__alloyId1647.add($.__views.precoA);
    ...
    $.__views.__alloyId1647.add($.__views.referenciaA);
    ...
    $.__views.__alloyId1647.add($.__views.tempoA);
    ...
    $.__views.__alloyId1647.add($.__views.selecionaA);
    ...
    $.__views.__alloyId1647.add($.__views.imagesA);
    ...
    $.__views.win.add($.__views.__alloyId1648);
    ...
    $.__views.__alloyId1649.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1650 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1650.addEventListener("click", voltar) : __defers["$.__views.__alloyId1650!click!voltar"] = true;
    ...
    $.__views.__alloyId1648.add($.__views.__alloyId1651);
    $.__views.__alloyId1652 = Ti.UI.createImageView({
    ...
    primeiro ? $.__views.__alloyId1652.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1652!click!primeiro"] = true;
    ...
    anterior ? $.__views.__alloyId1653.addEventListener("click", anterior) : __defers["$.__views.__alloyId1653!click!anterior"] = true;
    ...
    $.__views.__alloyId1651.add($.__views.paginacao);
    $.__views.__alloyId1654 = Ti.UI.createImageView({
    ...
    proximo ? $.__views.__alloyId1654.addEventListener("click", proximo) : __defers["$.__views.__alloyId1654!click!proximo"] = true;
    ...
    $.__views.__alloyId1651.add($.__views.__alloyId1655);
    ultimo ? $.__views.__alloyId1655.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1655!click!ultimo"] = true;
    ...
    $.__views.__alloyId1651.add($.__views.__alloyId1656);
    goToListaProdutos ? $.__views.__alloyId1656.addEventListener("click", goToListaProdutos) : __defers["$.__views.__alloyId1656!click!goToListaProdutos"] = true;
    ...
    $.__views.__alloyId1648.add($.__views.__alloyId1657);
    ...
    cesta ? $.__views.__alloyId1658.addEventListener("click", cesta) : __defers["$.__views.__alloyId1658!click!cesta"] = true;
    ...
    $.__views.__alloyId1657.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1650!click!voltar"] && $.__views.__alloyId1650.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1652!click!primeiro"] && $.__views.__alloyId1652.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1653!click!anterior"] && $.__views.__alloyId1653.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1654!click!proximo"] && $.__views.__alloyId1654.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1655!click!ultimo"] && $.__views.__alloyId1655.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1656!click!goToListaProdutos"] && $.__views.__alloyId1656.addEventListener("click", goToListaProdutos);
    __defers["$.__views.__alloyId1658!click!cesta"] && $.__views.__alloyId1658.addEventListener("click", cesta);
    _.extend($, exports);
}
