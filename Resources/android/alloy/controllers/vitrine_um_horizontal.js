...
function Controller() {
    ...
    $.__views.win.add($.__views.__alloyId1649);
    ...
    $.__views.__alloyId1649.add($.__views.gradeA);
    ...
    $.__views.gradeA.add($.__views.__alloyId1650);
    $.__views.imagemA = Ti.UI.createImageView({
        width: "100%",
        id: "imagemA"
    });
    $.__views.__alloyId1650.add($.__views.imagemA);
    ...
    $.__views.gradeA.add($.__views.__alloyId1651);
    ...
    $.__views.__alloyId1651.add($.__views.precoA);
    ...
    $.__views.__alloyId1651.add($.__views.referenciaA);
    ...
    $.__views.__alloyId1651.add($.__views.tempoA);
    ...
    $.__views.__alloyId1651.add($.__views.selecionaA);
    ...
    $.__views.__alloyId1651.add($.__views.imagesA);
    ...
    $.__views.__alloyId1653.add($.__views.botaoQuatroVerticais);
    ...
    $.__views.__alloyId1654 = Ti.UI.createButton({
        backgroundColor: "#008382",
        borderRadius: "5",
        color: "#ffffff",
        height: "60%",
    ...
    voltar ? $.__views.__alloyId1654.addEventListener("click", voltar) : __defers["$.__views.__alloyId1654!click!voltar"] = true;
    ...
    primeiro ? $.__views.__alloyId1656.addEventListener("click", primeiro) : __defers["$.__views.__alloyId1656!click!primeiro"] = true;
    ...
    anterior ? $.__views.__alloyId1657.addEventListener("click", anterior) : __defers["$.__views.__alloyId1657!click!anterior"] = true;
    ...
    $.__views.__alloyId1655.add($.__views.paginacao);
    ...
    proximo ? $.__views.__alloyId1658.addEventListener("click", proximo) : __defers["$.__views.__alloyId1658!click!proximo"] = true;
    ...
    $.__views.__alloyId1655.add($.__views.__alloyId1659);
    ultimo ? $.__views.__alloyId1659.addEventListener("click", ultimo) : __defers["$.__views.__alloyId1659!click!ultimo"] = true;
    ...
    $.__views.__alloyId1655.add($.__views.__alloyId1660);
    goToListaProdutos ? $.__views.__alloyId1660.addEventListener("click", goToListaProdutos) : __defers["$.__views.__alloyId1660!click!goToListaProdutos"] = true;
    ...
    cesta ? $.__views.__alloyId1662.addEventListener("click", cesta) : __defers["$.__views.__alloyId1662!click!cesta"] = true;
    ...
    $.__views.__alloyId1661.add($.__views.quantidade);
    ...
    __defers["$.__views.__alloyId1654!click!voltar"] && $.__views.__alloyId1654.addEventListener("click", voltar);
    __defers["$.__views.__alloyId1656!click!primeiro"] && $.__views.__alloyId1656.addEventListener("click", primeiro);
    __defers["$.__views.__alloyId1657!click!anterior"] && $.__views.__alloyId1657.addEventListener("click", anterior);
    __defers["$.__views.__alloyId1658!click!proximo"] && $.__views.__alloyId1658.addEventListener("click", proximo);
    __defers["$.__views.__alloyId1659!click!ultimo"] && $.__views.__alloyId1659.addEventListener("click", ultimo);
    __defers["$.__views.__alloyId1660!click!goToListaProdutos"] && $.__views.__alloyId1660.addEventListener("click", goToListaProdutos);
    __defers["$.__views.__alloyId1662!click!cesta"] && $.__views.__alloyId1662.addEventListener("click", cesta);
    _.extend($, exports);
}
