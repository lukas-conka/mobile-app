...
// in simulator we redefine to format for E_Catalogos Developer console
...
{\
	NSString * exceptionName = [@"org.e_catalogos." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.e_catalogos";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIE_CatalogosNativeItemNone = -1, 
	UIE_CatalogosNativeItemSpinner = -2,
	UIE_CatalogosNativeItemProgressBar = -3,
	
	UIE_CatalogosNativeItemSlider = -4,
	UIE_CatalogosNativeItemSwitch = -5,
	UIE_CatalogosNativeItemMultiButton = -6,
	UIE_CatalogosNativeItemSegmented = -7,
	
	UIE_CatalogosNativeItemTextView = -8,
	UIE_CatalogosNativeItemTextField = -9,
	UIE_CatalogosNativeItemSearchBar = -10,
	
	UIE_CatalogosNativeItemPicker = -11,
	UIE_CatalogosNativeItemDatePicker = -12,
	
	UIE_CatalogosNativeItemInfoLight = -13,
	UIE_CatalogosNativeItemInfoDark = -14,
	
	UIE_CatalogosNativeItemDisclosure = -15,
	
	UIE_CatalogosNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all E_Catalogos instances of
