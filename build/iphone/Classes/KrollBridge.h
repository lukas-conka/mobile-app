...
@interface E_CatalogosObject : KrollCoverageObject {
#else
@interface E_CatalogosObject : KrollObject {
#endif
@private
...
extern NSString * E_Catalogos$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	E_CatalogosObject *_e_catalogos;
    KrollObject* console;
	BOOL shutdown;
