...
/**
 Base class for all E_Catalogos views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the E_Catalogos view hierarchy (such as wrapped iOS UIViews) was touched.
