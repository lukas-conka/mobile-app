...
/**
 The base class for all E_Catalogos modules
 */
...
/**
 E_Catalogos Platform calls this method on startup.
 */
-(void)startup;

/**
 E_Catalogos Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 E_Catalogos Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 E_Catalogos Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 E_Catalogos Platform calls this method on resume.
 @param sender The sender of the event.
 */
