...
//@interface E_CatalogosObject : NSObject
//@end

@interface E_CatalogosObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[E_CatalogosObject class]])
		{
			for (NSString *key in [[(E_CatalogosObject*)o modules] allKeys])
			{
