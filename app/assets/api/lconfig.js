...
if(contX == contY || contX == 0 && contW == 0){
	contX++;
...
alert("Entrou na funcao 3"+contX);
	...
	// var valoresI = Ti.App.Properties.getList("valores");
	//alert(valoresI);
	...
	var result = "false";
	//var aux = vet_aux.indexOf(id);
	//alert(aux);
	
	if (checkSelectedProduct(id) == "false" && vet_aux.indexOf(id) == -1) {
		alert("SIM");
		contZ++;
...
function redimencionaVitrine(vitrine) {
	...
	if (Ti.Platform.osname != "android") {
		alturaTela = alturaTela - 50;
		larguraTela = larguraTela - 50;
	}
